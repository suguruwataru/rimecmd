/// Data taken from src/rime/key_table.cc of the project librime,
/// commit 5f5a688.
...
/// encoding. Rime supports many more keys, but for now, for simplicity,
/// only keys that correspond to ASCII characters are used here.
pub fn rime_character_to_key_name_map() -> HashMap<char, &'static str> {
    HashMap::from([
        (' ', "space"),
        ('!', "exclam"),
        ('"', "quotedbl"),
...
pub fn rime_key_name_to_key_code_map() -> std::collections::HashMap<&'static str, usize> {
